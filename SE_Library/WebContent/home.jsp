		...
		<div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
			<div class="row">
				<div class="col-md-6 px-0">
					<p class="lead my-3">SE library introduction</p>
					<p class="lead mb-0"><a class="text-white font-weight-bold">경기대학교의 자랑 SE도서관에 방문하기 위해 저희 웹사이트를 찾아주셔서 감사합니다. 오늘도 지식이 충만한 하루 보내시길 바랍니다.</a></p>
				</div>
